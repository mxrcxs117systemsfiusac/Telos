...
import { Heart, Plus, Trash2, X, Sparkles, ThumbsUp, ThumbsDown, Star, User, BookOpen } from 'lucide-react';
...
const CATEGORIES = [
    ...
    { key: 'album', label: 'Álbum', icon: BookOpen, color: 'from-fuchsia-500 to-pink-500', accent: 'fuchsia' },
];
